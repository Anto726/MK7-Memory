...
BEGIN_NAMESPACE(UI)
{
    /START_CLASS/NAME@MenuWaitMark/SIZE@0xB4/BASE@BaseMenuViewControl/BSIZE@0xA8/VTABLE@True/
    public:
        ...
        virtual ~MenuWaitMark();
        virtual void onCreate(const Control::CreateArg *);
        virtual void onReset();
        virtual void animMenuIn();
        virtual void animMenuOut();
