...
BEGIN_NAMESPACE(Sound)
{
    ...
    public:
        virtual void pauseOn(s32);                                                      // offset 0x48
        virtual void pauseOff(s32);                                                     // offset 0x4C
        virtual void fadeIn(s32);                                                       // offset 0x50
        virtual void stopAll(s32);                                                      // offset 0x54
        virtual void _0x58();                                                           // offset 0x58
        virtual void _0x5C();                                                           // offset 0x5C
        virtual void _0x60();                                                           // offset 0x60
        virtual void setActorVolume(f32);                                               // offset 0x64
        virtual void setActorPitch(f32);                                                // offset 0x68
        virtual void setActorPan(f32);                                                  // offset 0x6C
        virtual void startSound(u32, Sound::SndHandle*);                                // offset 0x70
        virtual void _0x74();                                                           // offset 0x74
        virtual Sound::SndHandle* startSoundPrioBefore(u32, Sound::SndHandle*);         // offset 0x78
        virtual void _0x7C();                                                           // offset 0x7C
        virtual void startSoundPrioAfter(u32, Sound::SndHandle*);                       // offset 0x80
        virtual void _0x84();                                                           // offset 0x84
        virtual void holdSound(u32, Sound::SndHandle*);                                 // offset 0x88
